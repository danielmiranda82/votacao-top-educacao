...
<div class="container">
  <div class="row">
    <div class="col-sm-6" align="left"><a href="https://premiotopeducacao.com.br/"><img src="https://premiotopeducacao.com.br/wp-content/uploads/2023/04/cropped-Logotipo-Top-Educacao-2023.png" width="120"  alt="" /></a> </div>
        ...
        <div class="accordion-item">
          ...
          <div id="flush-collapse-<?php echo $linha['codigo'];?>" class="accordion-collapse collapse" aria-labelledby="flush-heading-<?php echo $linha['codigo'];?>" data-bs-parent="#accordionFlushCatBasica">
            <div class="accordion-body" align="center">
              ...
              $sqlCandidatos = "SELECT * FROM wp_candidatos WHERE id_categoria =  " . $linha[ "codigo" ] . "";
              $dadosCandidatos = mysqli_query( $conexao, $sqlCandidatos )or die( mysql_error() );
              $linhaCandidatos = mysqli_fetch_assoc( $dadosCandidatos );
              $totalCandidatos = mysqli_num_rows( $dadosCandidatos );
              ...
              if ( $totalCandidatos > 0 ) {
                ...
                do {
                  ...
                  echo "<input type='radio'  name='candidato' 
					value='" . $linhaCandidatos[ 'id_candidato' ] . '&' . $linhaCandidatos[ 'candidato' ] . "'>

					<label for='" . $linhaCandidatos[ 'candidato' ] . "'>" . $linhaCandidatos[ 'candidato' ] . "</label><br><br>";


                }
                while ( $linhaCandidatos = mysqli_fetch_assoc( $dadosCandidatos ) );
              ...
              <div align="center"> 
                ...
                <button class="btn btn-primary btn-sm" type="submit" style="width: 80%;">Votar</button>
              </div>
              <?php
              }
              ?>
        ...
        <div class="accordion-item">
          ...
          <div id="flush-collapse-<?php echo $linha['codigo'];?>" class="accordion-collapse collapse" aria-labelledby="flush-heading-<?php echo $linha['codigo'];?>" data-bs-parent="#accordionFlushCatSup">
            <div class="accordion-body" align="center">
              ...
              if ( $total > 0 && ( $linha[ 'codigo' ] != '24' && $linha[ 'codigo' ] != '25' && $linha[ 'codigo' ] != '30' && $linha[ 'codigo' ] != '34' && $linha[ 'codigo' ] != '26' ) ) {
                ...
                echo "<input type='text' id='indicado' name='indicado' style='width: 80%;'>";
                ...
                if ( $totalCandidatos > 0 ) {
                  ...
                  do {
                    ...
                    echo "<input type='radio'  name='candidato' 
					value='" . $linhaCandidatos[ 'candidato' ] . '&' . $linhaCandidatos[ 'id_candidato' ] . "'>
                ...
                echo "<input type='radio'  name='indicado'>

					<label for='indicado'>  <input type='text' id='indicado' name='indicado' style='width: 80%;'> </label><br><br>";
...
c . nome AS nome_categoria,
  c . tipo,
  ca . candidato AS nome_candidato
FROM
wp_categorias c
JOIN
wp_candidatos ca ON c . codigo = ca . id_categoria;
<?php */?>